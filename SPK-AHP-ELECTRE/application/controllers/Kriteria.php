    ...
    class Kriteria extends CI_Controller {
		...
		public function tampil_data_1($matrik_kriteria, $jumlah_kolom)
		{
			...
			foreach ($kriteria as $row) {
				$list_data .= '<td class="text-center">' . $row->id_kriteria . '</td>';
			}
			$list_data .= '</tr>';
			$i = 0;
			foreach ($kriteria as $row) {
				$list_data .= '<tr>';
				$list_data .= '<td>' . $row->id_kriteria . '</td>';
				$ii = 0;
				foreach ($kriteria as $row2) {
		...
		public function tampil_data_2($matrik_normalisasi, $prioritas)
		{
			...
			$list_data2 .= '<tr><td></td>';
			foreach ($kriteria as $row) {
				$list_data2 .= '<td class="text-center">' . $row->id_kriteria . '</td>';
			}
			...
			foreach ($kriteria as $row) {
				$list_data2 .= '<tr>';
				$list_data2 .= '<td>' . $row->id_kriteria . '</td>';
				$jumlah = 0;
				$ii = 0;
				foreach ($kriteria as $row2) {
		...
		public function tampil_data_3($matrik_baris, $jumlah_matrik_baris)
		{
			...
			$list_data3 .= '<tr><td></td>';
			foreach ($kriteria as $row) {
				$list_data3 .= '<td class="text-center">' . $row->id_kriteria . '</td>';
			}
			...
			foreach ($kriteria as $row) {
				$list_data3 .= '<tr>';
				$list_data3 .= '<td>' . $row->id_kriteria . '</td>';
				$ii = 0;
				foreach ($kriteria as $row2) {
