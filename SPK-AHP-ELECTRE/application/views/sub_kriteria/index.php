	...
	<div class="card shadow mb-4">
		...
		<div class="card-header py-3">
			<div class="d-sm-flex align-items-center justify-content-between">
				<h6 class="m-0 font-weight-bold text-warning"><i class="fa fa-table"></i> <?= $key->keterangan . " (" . $key->id_kriteria . ")" ?></h6>
							...
							<tr align="center">
								...
								<td>
									<div class="btn-group" role="group">
										<a style="" data-toggle="modal" title="Edit Data" href="#editsk<?= $key['id_sub_kriteria'] ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
